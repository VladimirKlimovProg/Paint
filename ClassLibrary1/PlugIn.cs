...
namespace PlugIn
{
    public class ReverseTransform : WindowsFormsApplication1.IPlugin
        {
            public string Name
            {
                get
            ...
            public void Transform(WindowsFormsApplication1.IMainApp app)
            {
    ...
    public class RandomTransform : WindowsFormsApplication1.IPlugin
        {
            public string Name
            {
                get
